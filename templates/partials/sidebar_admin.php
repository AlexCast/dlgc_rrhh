...
/**
 * Menú lateral reutilizable para el dashboard de administración (firstpage.php).
 * Los módulos se organizan en las mismas categorías colapsables que sidebar_nav.php,
 * de modo que todos los módulos tengan una categoría asignada.
 * Variable esperada:
...
$iconAdmin        = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="4" y1="21" x2="4" y2="14"></line><line x1="4" y1="10" x2="4" y2="3"></line><line x1="12" y1="21" x2="12" y2="12"></line><line x1="12" y1="8" x2="12" y2="3"></line><line x1="20" y1="21" x2="20" y2="16"></line><line x1="20" y1="10" x2="20" y2="3"></line><line x1="1" y1="14" x2="7" y2="14"></line><line x1="9" y1="8" x2="15" y2="8"></line><line x1="17" y1="16" x2="23" y2="16"></line></svg>';
...
$iconPermisos     = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>';
$iconCodigos      = '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>';
...
$grupos = [
    ...
    'empresa' => [
        ...
        'icono'  => $iconEmpresa,
        'modulos' => [
            ['id' => 4,  'slug' => 'empleados',     'titulo' => 'Empleados',              'url' => '/dlgc_rrhh/src/empleados/listar_empleados.php',                            'icono' => $iconEmpleados],
    ...
    'software' => [
        ...
        'modulos' => [
            ...
            ['id' => 21, 'slug' => 'permisos_usuarios', 'titulo' => 'Permisos por Usuario', 'url' => '/dlgc_rrhh/src/permisos_usuarios/listar_permisos_usuarios.php',         'icono' => $iconPermisos],
            ['id' => 23, 'slug' => 'codigos_registro',  'titulo' => 'Códigos de Registro',  'url' => '/dlgc_rrhh/templates/codigos_registro.php',                             'icono' => $iconCodigos],
        ],
    ],
    'administracion' => [
        ...
        'icono'  => $iconAdmin,
        'modulos' => [
            ['id' => 24, 'slug' => 'admin_comunicados', 'titulo' => 'Administrar Comunicados', 'url' => '/dlgc_rrhh/src/comunicados/listar_comunicados.php', 'icono' => $iconComunicados],
...
if (!function_exists('renderGrupo')) {
...
<nav class="sidebar-nav" aria-label="Enlaces del panel">
    <ul>
        <?php echo renderNavItem('/dlgc_rrhh/templates/firstpage.php', 'Inicio RRHH', $iconInicio, 'inicio', $activeItem); ?>
