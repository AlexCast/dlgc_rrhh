...
<body>
                ...
                <div class="employees-layout">
                    ...
                    <section class="availability-panel" id="availability-panel">
                        ...
                        <div class="calendar-container hidden" id="calendar-container">
                            ...
                            <button type="button" id="employee-info-btn" class="employee-info-btn" aria-label="Ver datos de contacto del empleado">
    ...
    <div id="employee-info-modal" class="employee-modal" role="dialog" aria-modal="true" aria-labelledby="employee-info-title" hidden>
        <div class="employee-modal-backdrop"></div>
        <div class="employee-modal-panel">
            <div class="employee-modal-header">
                <h3 id="employee-info-title">Datos de contacto</h3>
                <button type="button" id="employee-info-close" class="employee-modal-close" aria-label="Cerrar">×</button>
            </div>
            <div class="employee-modal-body">
                <div class="employee-modal-avatar" id="employee-modal-avatar"></div>
                <p class="employee-modal-name" id="employee-modal-name"></p>
                <p class="employee-modal-role" id="employee-modal-role"></p>
                <ul class="employee-modal-list">
                    <li>
                        ...
                        <span id="employee-modal-phone"></span>
                    </li>
                    <li>
                        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z"></path><polyline points="22,6 12,13 2,6"></polyline></svg>
                        <span id="employee-modal-email"></span>
                    </li>
                </ul>
            </div>
        </div>
