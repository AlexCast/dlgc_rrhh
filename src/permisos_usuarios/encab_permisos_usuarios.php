...
<head>
    ...
    <title>DLGC | Permisos por Usuario</title>
...
<body>
    <header class="header-container">
        <div class="header-content">
            ...
            <nav class="nav-menu">
                <div class="nav-item">
                    <a href="listar_permisos_usuarios.php" class="nav-link" aria-label="Listar">
                        <i class="fas fa-list" aria-hidden="true"></i>
                        <span class="nav-text">Listar</span>
                    </a>
                </div>
                <?php if (has_module_permission(21, 'crear')): ?>
                <div class="nav-item">
                    <a href="forma_permisos_usuarios.php" class="nav-link" aria-label="Agregar">
