...
<head>
    ...
    <title>DLGC | Mis Afiliaciones</title>
...
<body>
    <header class="header-container">
        <div class="header-content">
            ...
            <nav class="nav-menu">
                <div class="nav-item">
                    <a href="listar_afiliaciones_empleados.php" class="nav-link" aria-label="Listar">
                ...
                <div class="nav-item">
                    <a href="forma_afiliaciones_empleados.php" class="nav-link" aria-label="Agregar">
